...
//            session.setDebug(true);
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int res=sendEmail("smtp.qq.com", "842391412@qq.com", "evgeqxfpcwsubdia", "842391412@qq.com", new String[]{
    			"842391412@qq.com" //这里就是一系列的收件人的邮箱了
    	}, "节日祝福", "祝你快乐","text/html;charset=utf-8");
